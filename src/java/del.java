       ...
       else
       {
        ...
        try (PrintWriter out = response.getWriter()) {
           /*  TODO output your page here. You may use following sample code. */
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Remove Contact</title>");
...
out.print("<td>");
out.print("<form action=\"Delete\" >");
out.print("<input name=\"name\" id=\"name\" value="+phone+" type=\"hidden\" required/></p>");
out.println("<input  class =\"del\" type=\"submit\"  value=\"Remove\" />");
out.print("               </form>");
out.print("           </td>");
out.print("                </tr>");
