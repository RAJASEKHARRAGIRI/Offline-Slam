       ...
       String key=request.getParameter("key");
        ...
        try (PrintWriter out = response.getWriter()) {
           /*  TODO output your page here. You may use following sample code. */
            ...
            out.print("    	<h1><a href=\"#\">DATABASE MANAGER</a></h1>");
...
out.print("            <li class=\"selected1\"><a href=\"add.html\">Add Database</a></li>");
out.print("            <li class=\"selected2\"><a href=\"del\">Remove Database</a></li>");
...
out.print("                                <p>");
out.print("                                    <input class=\"field\"  size=\"20\" name=\"key\" placeHolder=\"Enter name to search\" class=\"s\" type=\"text\">");
...
FileReader fr=new FileReader("userdata/data");
	...
	while((s=br.readLine())!=null)
	{
		StringTokenizer st=new StringTokenizer(s,"::");
                ...
                if(name.contains(key)|| phone.contains(key)||name.toLowerCase().contains(key)) {
                out.print("                <tr>                    ");
